...
namespace PayloadExample {
  /// <summary>
  /// Models the finite state machine that can pass payloads between states
  /// </summary>
  public class FiniteStateMachine {
    ...
    public void ChangeState<S>(object payload = null) where S : State {
      ChangeState(states[typeof(S)], payload);
    }
    ...
    /// </summary>
    public void ChangeToDefault(object payload = null) {
      ChangeState(defaultState, payload);
    }
  }
}